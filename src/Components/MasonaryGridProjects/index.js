...
import "./MasonaryGridProjects.css";
    ...
    <div className="mason-container">
      <section className="animated-grid">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1502134249126-9f3755a50d78?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80'"
          }}
        ></div>
      </section>
    </div>
